...
class CortexWebSocketServer:
    ...
    async def register_client(self, websocket: websockets.server.WebSocketServerProtocol):
    ...
    async def unregister_client(self, websocket: websockets.server.WebSocketServerProtocol, reason: str = ""):
    ...
    async def send_error(self, websocket: websockets.server.WebSocketServerProtocol, code: str, message: str):
    ...
    async def send_to_client(self, websocket: websockets.server.WebSocketServerProtocol, message: Dict[str, Any]):
